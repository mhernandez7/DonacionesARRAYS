 ...
 * @author Miguel
 */
public class Prendas extends Persona {
     ...
     public void registroDonacion(ArrayList<Persona>lista){
            ...
            System.out.println("Ingrese el nombre de la Prenda que desa donar: ");
    ...
    public void impresionDonacion(ArrayList<Persona>lista){
        ...
        for(int i=0; i<lista.size();i++){
         ...
         System.out.println("Articulo Donado: Prenda Descripcion: "+lista.get(i).articuloDona);
        }
